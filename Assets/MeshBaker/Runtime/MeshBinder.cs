...
namespace MRvfx
{
    [AddComponentMenu("VFX/Property Binders/MRvfx/Mesh Binder")]
    [VFXBinder("MRvfx/Mesh")]
    public class MeshBinder : VFXBinderBase
    {
        ...
        public override string ToString()
          => $"Mesh : '{_positionMapProperty}' -> {Target?.name ?? "(null)"}";
    }
